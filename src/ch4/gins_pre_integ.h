//
// Created by kangyu on 2023/11/28.
//

#ifndef SLAM_IN_AUTONOMOUS_DRIVING_GINS_PRE_INTEG_H
#define SLAM_IN_AUTONOMOUS_DRIVING_GINS_PRE_INTEG_H
...
public:
  ...
  struct Options {
    ...
    Mat3d bg_rw_info_ = Mat3d::Identity(); // 陀螺随机游走信息矩阵
    Mat3d ba_rw_info_ = Mat3d::Identity(); // 加速度计随机游走信息矩阵
...
#endif // SLAM_IN_AUTONOMOUS_DRIVING_GINS_PRE_INTEG_H
