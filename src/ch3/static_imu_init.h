...
#ifndef SLAM_IN_AUTONOMOUS_DRIVING_STATIC_IMU_INIT_H
#define SLAM_IN_AUTONOMOUS_DRIVING_STATIC_IMU_INIT_H
...
private:
  ...
  Vec3d cov_acce_ = Vec3d::Zero(); // 加速度计测量噪声协方差（初始化时评估）
...
#endif // SLAM_IN_AUTONOMOUS_DRIVING_STATIC_IMU_INIT_H
