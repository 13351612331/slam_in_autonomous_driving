...
#ifndef SLAM_IN_AUTONOMOUS_DRIVING_KDTREE_H
#define SLAM_IN_AUTONOMOUS_DRIVING_KDTREE_H
...
// Kd树节点，二叉树结构，内部用裸指针，对外一个root的shared_ptr
struct KdTreeNode {
  int id_ = -1;
  ...
  bool IsLeaf() const {
    return left_ == nullptr && right_ == nullptr; // 是否为叶子
  }
};
...
#endif // SLAM_IN_AUTONOMOUS_DRIVING_KDTREE_H
