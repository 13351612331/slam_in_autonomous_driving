...
#ifndef SLAM_IN_AUTONOMOUS_DRIVING_OCTO_TREE_H
#define SLAM_IN_AUTONOMOUS_DRIVING_OCTO_TREE_H
...
private:
  ...
  int k_ = 5;                                    // knn最近邻数量
  std::shared_ptr<OctoTreeNode> root_ = nullptr; // 根节点
...
#endif // SLAM_IN_AUTONOMOUS_DRIVING_OCTO_TREE_H
